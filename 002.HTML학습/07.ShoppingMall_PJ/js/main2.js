...
/***************************************************** 
    ...
    4. 기능 설계:
        ...
        (1) 아랫쪽 버튼 클릭시 다음 슬라이드가
            나타나도록 슬라이드 박스의 translate Y축방향 값을
            -100%로 변경시킨다.
            -> 슬라이드 이동후!!! 
            바깥에 나가있는 첫번째 슬라이드
            li를 잘라서 맨뒤로 보낸다!
            동시에 translate Y축방향 값을 0으로 변경한다!

        (2) 윗쪽 버튼 클릭시 이전 슬라이드가
            나타나도록 하기위해 우선 맨뒤 li를
            맨앞으로 이동하고 동시에 translate Y축방향 값을
            -100%로 변경한다.
            그 후 translate Y축방향 값을 0으로 애니메이션하여
            슬라이드가 윗쪽에서 들어온다.
  ...
  if (isBtn) {
    ...
    setTimeout(() => {
      $slide
        ...
        // 이때 translate값 초기화
        .css({ translate: "0 0", trnasition: "none" });
    }, TIME_ANI);
  } ///// if /////
  // (2-2) 아랫쪽 방향으로 이동
  else {
