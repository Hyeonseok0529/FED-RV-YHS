...
class Weather extends Component {
  ...
  constructor(props) {
    // 부모 = Component 에게 전달변수를 보내준다
    // 부모 클래스는 super 키워드로 호출한다
    super(props);
    // 생성자 함수구역 멤버변수 즉, 클래스속성을
    // 만들면 이것이 상태변수가 된다
    // 클래스 내부 속성은 this 키워드를 사용한다
    // 받아온 날씨 정보를 셋업할 객체임!
    // state 이름의 상태변수에 setState()로 셋팅한다
    this.state = {
      // 1. 기온
      temp: "",
      // 2. 설명
